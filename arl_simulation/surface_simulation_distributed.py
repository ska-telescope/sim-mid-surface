...
from wrappers.serial.imaging.primary_beams import create_pb, create_vp, create_vp_generic_numeric
from wrappers.serial.imaging.base import create_image_from_visibility, advise_wide_field
from wrappers.serial.simulation.surface import simulate_gaintable_from_voltage_patterns
...
def create_vis_list_with_errors(sub_bvis_list, sub_components, sub_model_list, vp_list,
    ...
    no_error_gt_list = [arlexecute.execute(simulate_gaintable_from_voltage_patterns)
                        (bvis, sub_components, no_error_vp_list, no_error_vp_coeffs, use_radec=use_radec)
                        for ibv, bvis in enumerate(sub_bvis_list)]
    error_gt_list = [arlexecute.execute(simulate_gaintable_from_voltage_patterns)
